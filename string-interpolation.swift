...
print("You should follow me on Twitter: \(twitter: "ianchen0419")")
...
let hearBreaker = Person(type: "heart-breaker", action: "break")
let faker = Person(type: "faker", action: "fake")
print("Let's sing: \(player, count: 5) \(hater, count: 5) \(hearBreaker, count: 5) \(faker, count: 5)")
